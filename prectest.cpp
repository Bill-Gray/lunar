...
int main( const int argc, const char **argv)
{
   ...
   for( pass = 0; pass < 4; pass++)
      {
      double matrix[9];
      const char *labels[4] = { "IAU1976 precession,  no nutation:", "With IAU1980 nutation:",
                     "IAU1980 nutation rotated by GST (should be close to below)",
      ...
      switch( pass)
         ...
         case 1: case 2:
            ...
            if( pass == 2)
               spin_matrix( matrix + 3, matrix, green_sidereal_time( utc));
            break;
         case 3:
...
/*
phred@phred:~/lunar$ ./prectest "2016 aug 1"
Polar motion: 0.213185 x, 0.449021 y (arcseconds)
TDT - UT1 = 68.409532 seconds
TDT - UT1 = 68.339919 seconds (from 'standard' function)
